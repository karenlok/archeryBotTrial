...
const { SearchCompetitionRecognizer } = require('./recognizer/searchCompetitionRecognizer');
...
// configure connection settins to connect to the Azure
...
const cluRecognizer = new SearchCompetitionRecognizer(cluConfig);
